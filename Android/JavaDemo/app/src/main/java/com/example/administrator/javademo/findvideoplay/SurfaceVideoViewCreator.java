package com.example.administrator.javademo.findvideoplay;
        ...
        MediaPlayer.OnInfoListener
{
    ...
    private void prepareStart(String videoPath){
        try{
            ...
            videoFile =
                    new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "ruiyihong"
                            + File.separator + "video/"+temp[temp.length-1]);
