package com.example.administrator.javademo.view;
...
public class MoreTextView extends LinearLayout {
    ...
    protected void initalize() {
        ...
        expandView.setText("查看更多");
        expandView.setTextColor(getResources().getColor(R.color.colorAccent));
//        expandView.setTextSize(getResources().getDimension(R.dimen.small_size));
        expandView.setTextSize(14);
        addView(expandView, LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
    ...
    public void setExpandViewBackground(int background){
        expandView.setBackgroundResource(background);
    }

    public void setExpandViewTextColor(int color){
        expandView.setTextColor(color);
    }
}
